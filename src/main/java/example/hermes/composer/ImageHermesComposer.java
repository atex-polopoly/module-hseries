...
import example.hermes.mappings.ElementNameEnum;
    ...
    public ContentResult<Object> compose(ContentResult<Object> imageBeanDataResult,
        ...
        try {
            ...
            if (s.equals("hermes")) {
                ...
                if (contentBean.getChild(ElementNameEnum.DESCRIPTION.getName()) != null && contentBean.getChild(ElementNameEnum.DESCRIPTION
                        .getName()).toString().trim().length() > 0) {
                    hermesElements.add(new HermesElement(ElementNameEnum.DESCRIPTION.getName(), ElementNameEnum.DESCRIPTION
                            .getPrintName(), HermesTypesEnum.CAPTION.getValue(), HermesConstants.HERMES_LEVEL_TEXTS, hermesDataType));
                }
                ...
                res = ContentResultBuilder.copy(imageBeanDataResult)
