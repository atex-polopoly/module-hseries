...
public class StandardArticleHermesComposer implements ContentComposer<Object, Object, Object> {
    ...
    private static final Logger LOGGER = Logger.getLogger(StandardArticleHermesComposer.class.getName());
        ...
        try {
            ...
            if (s.equals("hermes")) {
                ...
                if (content.getAspect(hermesAspectName) == null) {
                    ...
                    HermesElement spElement = new HermesElement(ElementNameEnum.ARTICLE.getName(), ElementNameEnum.ARTICLE
                            .getPrintName(), HermesTypesEnum.STORY_PACKAGE.getValue(), HermesConstants.HERMES_LEVEL_SP, hermesDataType);
                    //					spElement.getMetadata().put("WEB/AUTHOR", original.getByline());
                    hermesElements.add(spElement);

                    HermesElement titleElement = new HermesElement(ElementNameEnum.HEADLINE.getName(), ElementNameEnum.HEADLINE
                            .getPrintName(), HermesTypesEnum.HEADER.getValue(), HermesConstants.HERMES_LEVEL_TEXTS, hermesDataType);
                    // titleElement.getMetadata().put("WEB/SUBTYPE", "main title");
                    hermesElements.add(titleElement);

                    hermesElements.add(new HermesElement(ElementNameEnum.LEAD.getName(), ElementNameEnum.LEAD.getPrintName(), HermesTypesEnum.CAPTION
                ...
                res = ContentResultBuilder.copy(articleBeanDataResult)
